...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('frontend/assets/css/bootstrap-theme.css')}}">
	...
	{{-- <link rel="stylesheet" type="text/css" href="{{asset('frontend/assets/adminLTE/css/adminlte.min.css')}}"> --}}
...
<body class="home-page home-01 ">
							...
							<ul>
								@if (Route::has('HalamanLogin'))
									...
									<li class="menu-item menu-item-has-children parent" >
										<a title="Dollar (USD)" href="#">Akun Saya ( {{(Auth::user()->name)}} )<i class="fa fa-angle-down" aria-hidden="true"></i></a>
										<ul class="submenu curency" >
											<li class="menu-item" >
												<a title="Profile" href="{{route('HalamanProfile')}}">Profile</a>
											</li>
											<li class="menu-item" >
									...
									@else
									<li class="menu-item" ><a title="Register or Login" href="{{route('HalamanLogin')}}">Masuk</a></li>
									<li class="menu-item" ><a title="Register or Login" href="{{route('HalamanRegister')}}">Daftar</a></li>
									@endif
					...
					<div class="mid-section main-info-area">
						...
						<div class="wrap-icon right-section">
							...
							<div class="wrap-icon-section minicart">
								<a href="{{route('HalamanKeranjang')}}" class="link-direction">
									<i class="fa fa-shopping-basket" aria-hidden="true"></i>
									<div class="left-info">
										<span class="totalBarangKeranjangClass index">{{ totalBarangKeranjang() }}</span>
						...
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								<li class="menu-item home-icon">
									<a href="{{route('HalamanBeranda')}}" class="link-term mercado-item-title"><i class="fa fa-home" aria-hidden="true"></i></a>
								</li>
								<li class="menu-item">
									<a href="about-us.html" class="link-term mercado-item-title">About Us</a>
								</li>
								<li class="menu-item">
									<a href="{{route('HalamanBelanja')}}" class="link-term mercado-item-title">Shop</a>
								</li>
								<li class="menu-item">
									<a href="{{route('HalamanKeranjang')}}" class="link-term mercado-item-title">Cart</a>
								</li>
								<li class="menu-item">
									<a href="{{route('HalamanPemeriksaan')}}" class="link-term mercado-item-title">Checkout</a>
								</li>
								<li class="menu-item">
	...
	{{-- <script src="{{asset('adminLte/plugins/js/bootstrap.js')}}"></script> --}}
	{{-- <script src="{{asset('frontend/assets/adminLTE/js/adminlte.min.js')}}"></script> --}}
